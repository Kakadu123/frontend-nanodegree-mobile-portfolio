...
// processing time as phase assumes 5 distinct values
    ...
    var phaseValue = [];
    phaseValue[0] = Math.sin(scrollPos);
    phaseValue[1] = Math.sin(scrollPos + 1);
    phaseValue[2] = Math.sin(scrollPos + 2);
    phaseValue[3] = Math.sin(scrollPos + 3);
    phaseValue[4] = Math.sin(scrollPos + 4);
